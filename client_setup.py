...
from libs.locals import CLIENT_VERSION
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "TSSSF.py"
 
        #Name of program
        self.project_name = "TSSSFgame("+CLIENT_VERSION+")"
 
        #Project url
        self.project_url = ""
 
        #Version of program
        self.project_version = CLIENT_VERSION
 
        #License of the program
        self.license = ""
 
        #Auhor of program
        self.author_name = "Raubana"
        self.author_email = ""
        self.copyright = ""
 
        #Description
        self.project_description = "SHIPPING INTENSIFIED"
